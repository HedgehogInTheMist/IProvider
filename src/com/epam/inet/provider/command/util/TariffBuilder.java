...
public class TariffBuilder extends EntityBuilder<Tariff> {
    ...
    public static final String HOT_TARIFF = "hot";
    ...
    public void build(Map<String, String[]> map, Tariff tariff) throws BuildException {
        ...
        boolean hot = !buildHot(map.get(HOT_TARIFF), tariff);
        boolean type = !buildType(map.get(TARIFF_TYPE), tariff);

/*        LOGGER.debug("tariffname " + tariffname);
