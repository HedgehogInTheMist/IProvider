...
<div class="content">
    ...
    <%--<c:choose>
        <c:when test="${not empty orders or orders.size() > 0}">--%>
            <c:set var="total" value="${0}"/>
            <table class="order-table">
                <thead>
                <tr>
                    <th><fmt:message key="tariff_table.tariffname"/></th>
            ...
            <p><b><fmt:message key="account.table.total"/>: <fmt:formatNumber maxFractionDigits="1" type="number"  groupingUsed="false" value="${total}"/> <fmt:message key="currency"/></b></p>
