...
<div class="content">
    ...
    <div class="blocks">
        <div class="block block-search">
            ...
            <a href="ifuture?action=tariffs&lang=${locale}"><img id="search_pic" src="${pageContext.servletContext.contextPath}/images/search.png"/></a>
            <p><fmt:message key="block.search.text"/> </p>
        </div>

        <div class="block block-order">
            <h1><fmt:message key="block.order.title"/> </h1>
            <img id="order_pic" src="${pageContext.servletContext.contextPath}/images/order.png"/>
        ...
        <div class="block block-complete">
            ...
            <img id="complete_pic" src="${pageContext.servletContext.contextPath}/images/accept.png"/>
